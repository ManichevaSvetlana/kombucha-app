...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_notification__ = __webpack_require__(23);
...
Nova.booting(function (Vue, router, store) {
    ...
    Vue.component('index-account-contacts', __webpack_require__(3));
    Vue.component('detail-account-contacts', __webpack_require__(6));
    Vue.component('form-account-contacts', __webpack_require__(9));
});
        ...
        _c("div", { staticClass: "flex border-b border-40" }, [
          ...
          _c("div", { staticClass: "w-3/4 py-4" }, [
            _c("p", { staticClass: "text-90" }, [
              _vm._v(
                "\n                " +
                  _vm._s(_vm.field.value.customer_name) +
                  "\n            "
              )
            ])
          ])
        ...
        _c("div", { staticClass: "flex border-b border-40" }, [
          ...
          _c("div", { staticClass: "w-3/4 py-4" }, [
            _c("p", { staticClass: "text-90" }, [
              _vm._v(
                "\n                " +
                  _vm._s(_vm.field.value.days_before_delivery) +
                  "\n            "
              )
            ])
          ])
          ...
          _c("div", { staticClass: "w-3/4 py-4" }, [
            _c("p", { staticClass: "text-90" }, [
              _c("span", {
                ...
                class: _vm.field.value.reminder ? "bg-success" : "bg-warning"
              }),
              _vm._v(
                "\n                " +
                  _vm._s(_vm.field.value.reminder ? "Yes" : "No") +
                  "\n            "
              )
            ])
          ])
    ...
    methods: {
        ...
        getCustomer: function getCustomer() {
            ...
            if (this.contact.customer_name.length > 2) {
                axios.get('/customers/' + this.contact.customer_name + '/find').then(function (response) {
                    if (!response.data.result) {
                        if (response.data.status == 0) _this.$notify({
                            type: 'warn',
                            group: 'errors',
                        ...
                        _this.contact.customer_name = response.data.customer.name;
                        _this.contact.customer_id = response.data.customer.id;
                        _this.value = JSON.stringify(_this.contact);
                    }
                });
            }
        },
        setValue: function setValue(element) {
            this.value = JSON.stringify(this.contact);
        }
    }
});
  ...
  return _c(
    ...
    [
      _c(
        ...
        [
          _c("notifications", {
            attrs: { group: "errors", position: "bottom left" }
          }),
          _vm._v(" "),
          _c(
            "label",
          ...
          _c("small", [
            _vm._v(
              "Start to type a name or email address, and field will be populated with the Customer name."
            )
          ]),
          _vm._v(" "),
          _c("br"),
            ...
            directives: [
              {
                name: "model",
                rawName: "v-model",
                value: _vm.contact.customer_name,
                expression: "contact.customer_name"
              }
            ],
            staticClass: "w-full form-control form-input form-input-bordered",
            class: _vm.errorClasses,
            style: _vm.contact.customer_id ? "border-color: #00ff5e" : "",
            attrs: {
              id: _vm.field.name + "_customer_name",
              type: "text",
              placeholder: "Customer Name"
            },
            domProps: { value: _vm.contact.customer_name },
            on: {
              input: [
                function($event) {
                  ...
                  _vm.$set(_vm.contact, "customer_name", $event.target.value)
                },
                _vm.getCustomer
              ]
            }
          ...
          _c("small", [
            _vm._v(
              "Number of Days before delivery day the customer receives a text/email order reminder."
            )
          ]),
          _vm._v(" "),
          _c("br"),
            ...
            directives: [
              {
                name: "model",
                rawName: "v-model",
                value: _vm.contact.days_before_delivery,
                expression: "contact.days_before_delivery"
              }
            ],
            staticClass: "w-full form-control form-input form-input-bordered",
            class: _vm.errorClasses,
            attrs: {
              id: _vm.field.name + "_days_before_delivery",
              type: "number",
              placeholder: "Days Before Delivery To Receive Reminder"
            },
            domProps: { value: _vm.contact.days_before_delivery },
            on: {
              input: [
                function($event) {
                  if ($event.target.composing) {
                ...
                function($event) {
                  _vm.setValue("days_before_delivery")
                }
              ]
            }
          }),
            ...
            directives: [
              {
                name: "model",
                rawName: "v-model",
                value: _vm.contact.reminder,
                expression: "contact.reminder"
              }
            ],
            class: _vm.errorClasses,
            attrs: { id: _vm.field.name + "_reminder", type: "checkbox" },
            domProps: {
              checked: Array.isArray(_vm.contact.reminder)
                ? _vm._i(_vm.contact.reminder, null) > -1
                : _vm.contact.reminder
            },
            on: {
              change: [
                function($event) {
                  var $$a = _vm.contact.reminder,
                    $$el = $event.target,
                  ...
                  if (Array.isArray($$a)) {
                    ...
                    if ($$el.checked) {
                      $$i < 0 &&
                        _vm.$set(_vm.contact, "reminder", $$a.concat([$$v]))
                    } else {
                      $$i > -1 &&
                        _vm.$set(
                          _vm.contact,
                    ...
                    _vm.$set(_vm.contact, "reminder", $$c)
                  }
                },
                function($event) {
                  _vm.setValue("reminder")
                }
              ]
            }
          })
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(18), __webpack_require__(20).setImmediate))
