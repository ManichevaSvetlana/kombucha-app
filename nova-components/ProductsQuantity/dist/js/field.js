...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-products-quantity', __webpack_require__(3));
    Vue.component('detail-products-quantity', __webpack_require__(6));
    Vue.component('form-products-quantity', __webpack_require__(9));
});
  ...
  return _c("div", [
    _c("div", { staticClass: "flex border-b border-40" }, [
      ...
      _c(
        ...
        _vm._l(_vm.field.value.products, function(product) {
  ...
  return _c(
    ...
    [
      _c(
        "template",
        { slot: "field" },
        _vm._l(_vm.products.products, function(product) {
          return _c("div", { staticStyle: { width: "100%" } }, [
            _c("br"),
            _vm._v(" "),
            _c(
              ...
              directives: [
                {
                  ...
                  expression: "product.order_quantity"
                }
              ],
              staticClass: "w-full form-control form-input form-input-bordered",
              attrs: { id: product.id + "_product", type: "number" },
              domProps: { value: product.order_quantity },
              on: {
                change: _vm.setValue,
                input: function($event) {
                  ...
                  _vm.$set(product, "order_quantity", $event.target.value)
                }
              }
            })
          ])
