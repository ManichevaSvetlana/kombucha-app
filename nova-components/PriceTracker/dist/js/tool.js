...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_sweetalert2__ = __webpack_require__(10);
...
Nova.booting(function (Vue, router, store) {
    ...
    Vue.use(__WEBPACK_IMPORTED_MODULE_2_vue_sweetalert2__["a" /* default */], options);
    router.addRoutes([{
        name: 'price-tracker',
        path: '/price-tracker',
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_sweetalert2_dist_sweetalert2_min_js__ = __webpack_require__(11);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_sweetalert2_dist_sweetalert2_min_css__ = __webpack_require__(12);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    beforeCreate: function beforeCreate() {
        ...
        axios.get('/products').then(function (response) {
            ...
            _this.defaultProducts = JSON.parse(JSON.stringify(response.data));
        });
    },
    created: function created() {
        var path = window.location.toString().split('#')[1];
        var id = false;
    ...
    methods: {
        getCustomers: function getCustomers(search, loading) {
            var _this2 = this;

            var request = search;
            if (request.length > 1) {
                loading(true);
                axios.get('/customers?' + this.requestType + '=' + request).then(function (response) {
        ...
        getCustomer: function getCustomer() {
            ...
            if (this.request.value) {
                this.loading = true;
                axios.get('/customers/' + this.request.value).then(function (response) {
                    _this3.currentCustomer = response.data;
                    _this3.setDefaultPrices(Object.assign({}, _this3.defaultProducts));
                    if (_this3.currentCustomer.prices && _this3.currentCustomer.prices.length > 0) _this3.setPrices(_this3.currentCustomer.prices);
                    window.history.pushState("", "", '#customer=' + _this3.currentCustomer.id);
                    _this3.loading = false;
                    console.log(_this3.currentCustomer);
                }).catch(function (e) {
                    console.log(e);
                    alert(e.message);
                });
        ...
        setDefaultPrices: function setDefaultPrices(prices) {
        ...
        setPrices: function setPrices(prices) {
            for (var i = 0; i < this.products.length; i++) {
                var index = this.getIndexById(prices, this.products[i].id);
                if (index != -1) {
        ...
        getIndexById: function getIndexById(array, id) {
        ...
        updatePrices: function updatePrices() {
            ...
            if (this.currentCustomer.id) {
                this.loading = true;
                axios.post('/prices/' + this.currentCustomer.id, { products: this.products }).then(function (response) {
                    _this4.loading = false;
                    _this4.$swal('Prices were updated.');
                    console.log(response.data);
                }).catch(function (e) {
                    _this4.loading = false;
                    _this4.$swal(e.message);
        ...
        setCustomer: function setCustomer(id) {
            ...
            axios.get('/customers/' + id).then(function (response) {
                ...
                _this5.customers = [{ value: customer.id, label: customer.name + ' - ' + customer.email }];
                _this5.requestType = 'email';
                _this5.request = _this5.customers[0];
                _this5.currentCustomer = response.data;
                _this5.setDefaultPrices(Object.assign({}, _this5.defaultProducts));
                if (_this5.currentCustomer.prices && _this5.currentCustomer.prices.length > 0) _this5.setPrices(_this5.currentCustomer.prices);
                _this5.loading = false;
            }).catch(function (e) {
                _this5.loading = false;
                _this5.$swal(e.message);
                console.log(e.message);
            });
        }
    }
                  ...
                  [
                    _c(
                      "v-select",
                      {
                        ...
                        staticStyle: { border: "1px solid #bacad6" },
                        attrs: {
                        ...
                        on: {
                          search: _vm.getCustomers,
                          input: _vm.getCustomer
                        },
                        model: {
                          value: _vm.request,
                          callback: function($$v) {
              ...
              return !_vm.loading
                ? _c("div", [
                    _c("div", { staticClass: "flex border-b border-40" }, [
                      ...
                      _vm._v(" "),
                      _c("div", { staticClass: "py-4 px-6 w-1/2" }, [
                        _c("input", {
                          directives: [
                            {
                              name: "model",
                              ...
                              expression: "product.default_price"
                            }
                          ],
                          staticClass:
                            "w-full form-control form-input form-input-bordered",
                          attrs: { type: "text", placeholder: "Price" },
                          domProps: { value: product.default_price },
                          on: {
                      ...
                      _vm._v(" "),
                      _c("div", { staticClass: "py-2 px-2 w-1/2" }, [
                        _c("input", {
                          directives: [
                            {
                              name: "model",
                          ...
                          attrs: { type: "checkbox", placeholder: "Price" },
                          domProps: {
                            checked: Array.isArray(product.active)
                              ? _vm._i(product.active, null) > -1
                              : product.active
                          },
                          on: {
                            change: function($event) {
