...
Nova.booting(function (Vue, router, store) {
    ...
    Vue.component('index-belongs-to-with-type', __webpack_require__(3));
    Vue.component('detail-belongs-to-with-type', __webpack_require__(6));
    Vue.component('form-belongs-to-with-type', __webpack_require__(9));
});
...
var render = function() {
  ...
  return _c("span", [_vm._v(_vm._s(_vm.field.value.user.label))])
}
var staticRenderFns = []
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function created() {
        this.field.value = this.field.value.user.label;
    }
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        getUsers: function getUsers(search, loading) {
            ...
            if (request.length > 1) {
                loading(true);
                axios.get('/users?' + this.user.user_type + '=' + request).then(function (response) {
      ...
      _c(
        ...
        [
          _c(
            ...
            [
              _c("option", { attrs: { value: "user", selected: "selected" } }, [
                _vm._v("User")
              ]),
              _vm._v(" "),
              _c(
                "option",
                { attrs: { value: "customer", selected: "selected" } },
                [_vm._v("Customer")]
              ),
              _vm._v(" "),
              _c(
                "option",
                { attrs: { value: "sales_rep", selected: "selected" } },
          ...
          _c(
            "v-select",
            {
              ...
              on: { search: _vm.getUsers, input: _vm.setUser },
              model: {
                value: _vm.user.user,
                callback: function($$v) {
...
var update = __webpack_require__(21)("c9c9da74", content, false, {});
